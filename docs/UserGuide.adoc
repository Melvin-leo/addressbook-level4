...
The ScheduBook V1.4 is a program that helps studentas like you create and store a list of contacts and also helps you schedule your meetings so that you can better manage your time with your friends, your peers or even your professors or teachers. You can use Schedubook to remind you of a certain meeting you have on a day and Schedubook will remind you, further providing you information about the location you planned to meet.
...
** You can create meetings with multiple people at the same timing for an event(NameMeeting). In this case, multiple `Meeting Cards` will be created. A group meeting consists of meetings that have the same `NameMeeting`,`DateTime` and `Place` but with different person.
+
image::MeetingGroup.png[align="center"][width="200"]
+
** However, when opening Schedubook, if your next meeting is a group meeting, the reminder will show.
+
...
+
image::MeetingClash.png[align="center"][width="500"]
+
****
...
After you add meetings, the meetings will be represented by the meeting cards at the meeting list panel for you to keep track of your meetings. The meeting will display the purpose of the meeting, the date, time and the venue of the meeting, who you are meeting with and their contact number.


image::MeetingCard.png[align="center"][width="200"]
...
==== Pop up reminder
..  If there is a meeting scheduled on the day of logging in, a reminder that describes your next meeting will pop up for you to acknowledge.
+
